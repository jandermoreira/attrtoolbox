...
\begin{PDExample}
    ...
    \ATAttributeSet{name}{John}  % new content
    Hi, \ATAttributeGet{name}!
\end{PDExample}
...
\begin{Macrodef}{ATListSort}{\MArg{list-name}}{}
    Sorts alphabetically the contents of the list.
\end{Macrodef}

\begin{PDExample}
    \ATListCreate{a dolgaim}
    \ATListAppendItems{a dolgaim}{ágy, tükör, könyv, szék, asztal, ernyő, ajtó, hűtő, bőrönd, gyűrű}
    \ATListSort{a dolgaim}
    List of my things in Hungarian: \ATListForEach{a dolgaim}{\thing}[{ és }{, }{, és }{.}]{\thing}
\end{PDExample}
